...
// Edit Line 54, 55 with wifi credentials
// Edit Line 197 with your OSM Token
...
// Wifi Credentials
const char *ssid = "<your wifi>"; // your network SSID (name)
const char *pass = "<your wifi pw>"; // your network password
...
// senseBox ID
const char SENSEBOX_ID[] PROGMEM = "600afc3d9610e6001b5bab9a";
...
// sensor IDs
// Temperatur
const char TEMPERSENSOR_ID[] PROGMEM = "600afc3d9610e6001b5bab9f";
// rel. Luftfeuchte
const char RELLUFSENSOR_ID[] PROGMEM = "600afc3d9610e6001b5bab9e";
// Luftdruck
const char LUFTDRSENSOR_ID[] PROGMEM = "600afc3d9610e6001b5bab9d";
// PM10
const char PM10SENSOR_ID[] PROGMEM = "600afc3d9610e6001b5bab9c";
// PM2.5
const char PM25SENSOR_ID[] PROGMEM = "600afc3d9610e6001b5bab9b";
...
void submitValues() {
  ...
  for (uint8_t timeout = 2; timeout != 0; timeout--) {
    ...
    if (connected == true) {
      ...
      sprintf_P(buffer,
                PSTR("POST /boxes/%s/data HTTP/1.1\nAuthorization: <here your OSM Token>\nHost: %s\nContent-Type: "
                     "text/csv\nConnection: close\nContent-Length: %i\n\n"),
